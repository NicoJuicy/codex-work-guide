...
- Fit the canvas to the composition and remove redundant whitespace; treat an empty band wider than one card as a defect. / 让画布贴合实际构图，删除冗余留白；比一张卡片还宽的空白带视为缺陷。
